...
const ComsiganSettingModal = ({ isOpen, onClose }: Props) => {
    ...
    >
      ...
      >
        ...
        <div className="w-full h-full">
          ...
          <div className="mb-8">
            <p className="text-zinc-600 mb-2 select-none">컴시간알리미 검색 설정용 xlsx 다운로드:</p>
...
export default ComsiganSettingModal;
